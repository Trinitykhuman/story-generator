#narration , write up and load env
...
def create_advanced_prompt(style):
    ...
    **Core Instructions:**
    ...
    4.  **Nationality**: Use only Manipur Names,Characters, Manipur Places , Persona Etc.
    **Output Format:**
...
#Function for images , genre and generate. call to interface
...
#Audio narrator - GTTs lib (google text to speech)
